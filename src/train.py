...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_size", type=positive(int), default=IMAGE_SIZE,
        help="resize images to be of dimensions (image_size x image_size).")

    parser.add_argument("--image_channels", type=positive(int), default=NUM_CHANNELS,
        help="number of image channels in the dataset.")
    parser.add_argument("--num_latents", type=positive(int), default=NUM_LATENTS,
        help="number of latent factors from which an image will be generated.")
    parser.add_argument("--num_features", type=positive(int), default=NUM_FEATURES,
    ...
    parser.add_argument("--num_gpu", type=nonnegative(int), default=NUM_GPU,
        help="number of GPUs to use, if any.")
    parser.add_argument("--num_workers", type=nonnegative(int), default=NUM_WORKERS,
        help="number of workers that will be loading the dataset.")
    parser.add_argument("--batch_size", type=positive(int), default=BATCH_SIZE,
    ...
    parser.add_argument("--momentum", type=positive(float), default=MOMENTUM,
    ...
    parser.add_argument("--D_iters", type=positive(int), default=D_ITERS,
    ...
    parser.add_argument("--stats_interval", type=positive(int), default=STATS_REPORT_INTERVAL,
        help="the interval in which a report of the training stats will be shown to the console.")
    parser.add_argument("--progress_interval", type=positive(int), default=PROGRESS_CHECK_INTERVAL,
        help="the interval in which the progress of the generator will be checked and recorded.")

    ### Trainer.run() ###
    parser.add_argument("--num_epochs", type=positive(int), default=NUM_EPOCHS,
